        ...
        <div className="row align-items-center">
          <div className="col-lg-12">
            <p className="about-text">
              ...
              <b>Shaddan Textiles</b> was established in 1996 as a progressive
            ...
            <p className="about-text">
              ...
              <b>comfort, durability, and elegance</b>. Our company’s continuous
            ...
            <p className="about-text">
              ...
              <b>complete textile solution provider</b> — managing every aspect
            ...
            <p className="text-muted">
              ...
              <b>modern technology with traditional expertise</b> to produce
              ...
              <b>trust, quality, and reliability</b>.
            </p>
            ...
            <p className="text-muted">
              To be a <b>global leader</b> in the textile industry, recognized
